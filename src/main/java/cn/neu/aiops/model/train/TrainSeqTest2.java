...
public class TrainSeqTest2 {

	private static final Logger log = LoggerFactory.getLogger(TrainSeqTest2.class);

	public static void main(String[] args) throws IOException, InterruptedException {
		SequenceRecordReader trainDataReader = new CSVSequenceRecordReader();
		trainDataReader
				.initialize(new NumberedFileInputSplit(Util.WORK_DIR + "seq-embedding\\" + "brain-split-nodes-embedding - 副本 (%d).csv", 0, 19));
